...
enum NodeType {
    ...
    _MULTIPLY_NODE_, _DIVIDE_NODE_, _PLUS_NODE_, _MINUS_NODE_, _MODULO_NODE_, _NOT_NODE_, _LEFT_BITSHIFT_NODE_,
    _RIGHT_BITSHIFT_NODE_, _LOGICAL_AND_NODE_, _LOGICAL_OR_NODE_, _XOR_NODE_,
    ...
    _ELSE_IF_STMT_NODE_, _ELSE_STMT_NODE_, _VAR_TYPE_NODE_, _FINALLY_STMT_NODE_, _SUPER_STMT_NODE_,
    _INTERFACE_STMT_NODE_,
